...
buttons = [
    [
        InlineKeyboardButton('𝐓𝐌𝐑•𝐅𝐈𝐋𝐄𝐒', url='https://t.me/Tele_Movie_Rockerz')
    ]
    ]
def get_cmd(dur):
    if dur:
...
async def search(client, query):
    ...
    if query.query == "ETHO_ORUTHAN_PM_VANNU":
        answers.append(
            InlineQueryResultArticle(
                title="Deploy",
                input_message_content=InputTextMessageContent(f"{Config.REPLY_MESSAGE}\n\n<b>This bot was Made For @Tele_Movie_Rockerz\n[𝐓𝐌𝐑•𝐅𝐈𝐋𝐄𝐒](https://t.me/Tele_Movie_Rockerz)</b>", disable_web_page_preview=True),
