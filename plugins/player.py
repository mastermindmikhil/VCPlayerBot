...
async def notforu(_, m: Message):
    k = await _.send_cached_media(chat_id=m.chat.id, file_id="CAADBQADEgQAAtMJyFVJOe6-VqYVzAI", caption="You Are Not Authorized", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('𝐓𝐌𝐑•𝐅𝐈𝐋𝐄𝐒', url='https://t.me/Tele_Movie_Rockerz')]]))
    await delete_messages([m, k])
...
async def not_chat(_, m: Message):
    if m.from_user is not None and m.from_user.id in Config.SUDO:
        ...
        await m.reply("This is not the group which i have been configured to play,This bot was Made For @Tele_Movie_Rockerz\n[𝐓𝐌𝐑•𝐅𝐈𝐋𝐄𝐒](https://t.me/Tele_Movie_Rockerz)", reply_markup=InlineKeyboardMarkup(buttons))
        await delete_messages([m])
    else:
        buttons = [
            [
                InlineKeyboardButton('Join 𝐓𝐌𝐑•𝐅𝐈𝐋𝐄𝐒', url='https://t.me/Tele_Movie_Rockerz'),
            ]
            ]
        await m.reply("<b>Join \n[𝐓𝐌𝐑•𝐅𝐈𝐋𝐄𝐒](https://t.me/Tele_Movie_Rockerz)</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
