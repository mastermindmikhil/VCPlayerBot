...
async def main():
    ...
    if Config.DATABASE_URI:
        try:
            ...
            LOGGER.error(f"Errors occured while setting up database for VCPlayerBoy, check the value of DATABASE_URI. Full error - {str(e)}", exc_info=True)
            Config.STARTUP_ERROR="Errors occured while setting up database for VCPlayerBoy, check the value of DATABASE_URI. Full error - {str(e)}"
